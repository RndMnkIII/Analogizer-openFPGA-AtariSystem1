...
# ACDS 18.1 991 win32 2024.07.05.19:16:15
# ----------------------------------------
...
# ----------------------------------------
# If mf_pllsdram is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "mf_pllsdram"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mf_pllsdram.vo"
}
